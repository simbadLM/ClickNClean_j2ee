...
function acceptCleaner(id, accepted) {
    console.log("Redirecting to adming accept deny cleaner");
    let accepted_tag = accepted ? "&?accepted" : "";
    window.location.href = "http://localhost:9090/clickNclean_j2ee/AdminAcceptDenyCleaner?cleaner_id=" + id + "&accepted=" + accepted;
}